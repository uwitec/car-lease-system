...
<html>
	...
	<body style="text-align: center; font-size: 14px; font-family: '微软雅黑'">
		<table cellpadding="0" cellspacing="0" border="0">
			...
			<tr><td>养护内容:</td><td><input type="text" id="remark" style="width: 200px;" /></td></tr>
			<tr><td>养护日期:</td><td><input type="text" id="maintainDate" style="width: 200px;" /></td></tr>
			<tr><td>养护费用:</td><td><input type="text" id="money" style="width: 200px;" /></td></tr>
