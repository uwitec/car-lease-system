...
<html>
			...
			*/
			...
			$(function(){
				...
				$("#addFile").click(function(){
					...
					$.dqgb.shadowLayer.showMask({mask:'正在添加文件信息,请稍后....'});
					$.ajax({
						url:'addFile.action',
						async:true,
						type:'post',
						...
						success:function(data){
							if(data.RESULT != 'FAILED'){
								...
								$.dqgb.globalMsg.showMsg("文件信息添加成功!");
							}else{
	...
	<body style="font: 14px 微软雅黑;">
		<div style="width: 100%;text-align: center">
			<table  style='margin:0px auto; text-align: left; width:400px;' border="0" cellpadding="0" cellspacing="0" align="left">
				<tr>
		...
		<div style="width: 100%;text-align: center;clear: both;">
			<input type="button" id="addFile" style="width:50px; margin-top:20px;" value="保存" />
		</div>
	</body> 
</html>