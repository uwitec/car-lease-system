...
<html>
	...
	<body style="text-align: center;">
		<div style="width:280px; background-color:white; height:80px; text-align: center;" id="modifyUser">
			<table width=280>
				<tr>
					<td style="text-align: left;">组织编号：</td>
					<td colspan="2" style="text-align: left;">
						<input type="hidden" id="orgId" value="<s:property value='#session.Organization.id' />"/>
						<s:property value='#session.Organization.id' />
					</td>
				</tr>
				<tr>
					...
					<td colspan="2">
						...
						value = "<s:property value='#session.Organization.departmentName' />" />
					</td>
				</tr>
			</table>
		</div>
